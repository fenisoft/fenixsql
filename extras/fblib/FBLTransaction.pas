...
type
  ...
  TEndTransaction = procedure(Sender: TObject; trAction: TTRAction) of object;
  ...
  private
    ...
    function GetAttachDSqlCount: Integer;
  ...
  public
    ...
    {number of TFblDsql objects attached }
    property AttachDSqlCount:integer read GetAttachDsqlCount;
  published
...
function TFBLTransaction.GetAttachDSqlCount: Integer;
begin
  Result := FDSqls.Count;
end;
...
procedure TFBLTransaction.DoOnBeforeDisconnect;
begin
...
procedure TFBLTransaction.DoOnAfterDisconnect;
begin
